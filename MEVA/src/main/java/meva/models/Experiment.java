...
public class Experiment {
    ...
    public double getSpecimenDiameter() { return specimenDiameter; }
    public void setSpecimenDiameter(double specimenDiameter) { this.specimenDiameter = specimenDiameter; }
    ...
    public Double getTestTemperature() { return testTemperature; }
    public void setTestTemperature(Double testTemperature) { this.testTemperature = testTemperature; }
    
    public Double getTestSpeed() { return testSpeed; }
    public void setTestSpeed(Double testSpeed) { this.testSpeed = testSpeed; }
    ...
    public Double getMaxStress() { return maxStress; }
    public void setMaxStress(Double maxStress) { this.maxStress = maxStress; }
    
    public Double getStrainAtMaxStress() { return strainAtMaxStress; }
    public void setStrainAtMaxStress(Double strainAtMaxStress) { this.strainAtMaxStress = strainAtMaxStress; }
